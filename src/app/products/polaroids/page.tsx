...
export const metadata: Metadata = {
  ...
  description: "Premium Polaroid Prints by Paperboat Gifts & Forever Moments. Custom, handcrafted, delivered across India.",
};

export default function Page() {
  const items = getProductsByCategory("polaroids" as any);
  return (
    <>
      <Box sx={{ pt: 16, pb: 10, background: `linear-gradient(135deg, ${BRAND.purpleBlack}, ${BRAND.purpleDark})`, position: "relative", overflow: "hidden" }}>
        ...
        <Container maxWidth="lg" sx={{ position: "relative", textAlign: "center" }}>
          ...
          <Typography variant="h1" sx={{ color: "#fff", fontSize: { xs: "2.4rem", md: "3.8rem" }, mb: 2 }}>
            <Box component="span" sx={{ color: BRAND.gold, fontStyle: "italic" }}>Polaroid Prints</Box>
          </Typography>
