    ...
    <Box sx={{ py: { xs: 8, md: 12 }, backgroundColor: "#FDFBFF" }} ref={ref}>
      <Container maxWidth="lg">
        ...
        <Box sx={{
          ...
          "&::-webkit-scrollbar-thumb": { backgroundColor: `rgba(91,45,142,0.3)` },
        }}>
          {categories.map((cat, i) => (
            <motion.div
              ...
              style={{ flex: "0 0 auto", width: "calc(20% - 7px)", minWidth: 155 }}
            >
              <Link href={cat.href} style={{ textDecoration: "none" }}>
                <Box sx={{
                  ...
                  <Box
                    ...
                    src={cat.img}
                    alt={cat.label}
                    sx={{ width: "100%", height: "100%", objectFit: "cover", transition: "transform 0.55s ease" }}
                  />
                  <Box
                  ...
                  />
                  {/* Hover border */}
                  <Box className="cat-border" sx={{
                    position: "absolute", inset: 8,
                    border: `1px solid rgba(245,200,66,0.6)`,
                    opacity: 0, transition: "all 0.35s",
                  }} />
                  <Box sx={{ position: "absolute", bottom: 0, left: 0, right: 0, p: 2.5, textAlign: "center" }}>
                    <Typography sx={{
                      fontFamily: "'Playfair Display', serif",
                      fontSize:   "1rem", fontWeight: 600, color: "#FDFBFF", lineHeight: 1.3, mb: 0.5,
                    }}>
                      {cat.label}
                    </Typography>
                    <Typography sx={{
                      fontFamily:    "'Jost', sans-serif", fontWeight: 400,
                      fontSize:      "0.68rem", color: BRAND.gold, letterSpacing: "0.1em",
                    }}>
                      {cat.count}
                    </Typography>
                  </Box>
